...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '938773e64e6849bbbd1fad6025d6bb84',
  ...
  AUTHOR: 'LambertLiu', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://sspai.top', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'LambertLiu@yeah.net', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/iLambertLiu', // 你的github个人主页
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '陕ICP备2021004013号', // 备案号 闽ICP备XXXXXXX
